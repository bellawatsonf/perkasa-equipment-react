        ...
        <div className="bg-[url('/Sectionlast.jpg')] bg-cover h-[448px] w-[100%] pl-[87px]">
          <div className="pt-[101px] relative z-999 max-w-[70%]">
            ...
            <a href="https://wa.me/+6281321130071" target="_blank">
              <Button className="bg-[#F4FBFF] px-[32px] py-[12px] rounded-[999px] text-[black] h-auto text-[16px] border-solid border-1 border-[black]">
                Hubungi Kami
              </Button>
            </a>
          </div>
      ...
      <div className="block md:hidden">
        <div className="bg-[url('/Sectionlast.jpg'')] bg-cover">
          <div className="py-[40px] px-[20px]">
            ...
            <p className="text-[#1D1D1D] text-[14px] font-normal font-[Poppins]  pb-[32px]">
              Ayo bersama-sama membangun masa depan yang lebih kuat! Temukan
              solusi terbaik untuk proyek Anda dengan bekerja sama dengan
              perusahaan kami.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 px-[20px] md:px-[80px]">
          <div className="flex justify-start pt-[20px] md:py-[60px]">
            <div className="h-[auto]">
              ...
              <p className=" text-[white] text-[16px] md:text-[20px] font-bold font-[Poppins] py-[24px] text-left ">
                CV PERKASA HEAVY EQUIPMENT
              </p>
              <p className=" text-[white] text-[14px] md:text-[16px] font-normal font-[Poppins]  text-left ">
            ...
            <div>
              <div className="flex flex-row items-center">
                ...
                <a href="mailto:perkasa.phe@gmail.com" target="_blank">
                  <p className="text-[white] text-[14px] md:text-[20px] font-bold font-[Poppins] pt-[20px] md: pt-[90px] pb-[24px]  text-left ">
              ...
              <div className="flex flex-row items-center">
                ...
                <a href="https://wa.me/+6281321130071" target="_blank">
                  <p className="hover:cursor-pointer text-[white] text-[14px] md:text-[20px] font-bold font-[Poppins] pb-[24px] text-left ">
                    0813-2113-0071
                  </p>
                </a>
              </div>
